...
# 2 - Floor
class Maze(object):
  def __init__(self, config):# size, scale, heightmap, y_scale, num_runners, dead_end_chance):
    self.size, self.scale, self.y_scale = config['size'], config['scale'], config['y_scale']
  ...
  def gl_init(self):
    ...
    for x in range(self.size):
      for z in range(self.size):
        if self.map[x,z] == 2:
          glNormal( 0, 1, 0)
          glVertex((x + 0.5 - self.size / 2) * self.scale + self.scale / 2, -self.y_scale * self.scale / 2, (z + 0.5 - self.size / 2) * self.scale + self.scale / 2)
          glVertex((x + 0.5 - self.size / 2) * self.scale + self.scale / 2, -self.y_scale * self.scale / 2, (z + 0.5 - self.size / 2) * self.scale - self.scale / 2)
          glVertex((x + 0.5 - self.size / 2) * self.scale - self.scale / 2, -self.y_scale * self.scale / 2, (z + 0.5 - self.size / 2) * self.scale - self.scale / 2)
          glVertex((x + 0.5 - self.size / 2) * self.scale - self.scale / 2, -self.y_scale * self.scale / 2, (z + 0.5 - self.size / 2) * self.scale + self.scale / 2)
          glNormal( 0,-1, 0)
          ...
          #glVertex((x + 0.5 - self.size / 2) * self.scale - self.scale / 2, self.y_scale * self.scale / 2, (z + 0.5 - self.size / 2) * self.scale + self.scale / 2)
    glNormal( 1, 0, 0)
    glVertex(-self.size / 2 * self.scale, -self.y_scale * self.scale / 2,  self.size / 2 * self.scale)
    glVertex(-self.size / 2 * self.scale, -self.y_scale * self.scale / 2, -self.size / 2 * self.scale)
    glVertex(-self.size / 2 * self.scale, self.y_scale * self.scale / 2, -self.size / 2 * self.scale)
    glVertex(-self.size / 2 * self.scale, self.y_scale * self.scale / 2,  self.size / 2 * self.scale)
    glNormal(-1, 0, 0)
